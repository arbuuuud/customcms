+function ($) { "use strict";
    ...
    EnquireForm.prototype.addToolbarButton = function() {
    ...
    EnquireForm.prototype.initPreview = function() {
        this.initImageUploaders()
    }

    EnquireForm.prototype.updateScroll = function() {
        // Reserved in case MarkdownEditor uses scrollbar plugin
        // this.$preview.data('oc.scrollbar').update()
    }

    EnquireForm.prototype.initImageUploaders = function() {
        var self = this
    ...
    EnquireForm.prototype.pauseUpdates = function() {
        this.$markdownEditor.markdownEditor('pauseUpdates')
    }

    EnquireForm.prototype.resumeUpdates = function() {
        this.$markdownEditor.markdownEditor('resumeUpdates')
    }

    EnquireForm.prototype.initDropzones = function() {
    ...
    EnquireForm.prototype.initFormEvents = function() {
        $(document).on('ajaxSuccess', '#enquire-form', function(event, context, data){
    ...
    EnquireForm.prototype.initLayout = function() {
        $('#Form-secondaryTabs .tab-pane.layout-cell:not(:first-child)').addClass('padded-pane')
    }

    EnquireForm.prototype.replacePlaceholder = function(placeholder, placeholderHtmlReplacement, mdCodePlaceholder, mdCodeReplacement) {
        this.pauseUpdates()
    ...
    $(document).ready(function(){
        var form = new EnquireForm()

        if ($.oc === undefined)
            $.oc = {}

        $.oc.enquireEnquireForm = form
    })
