<?php namespace Mindimedia\Enquire\Classes;

/**
 * Enquire Markdown tag processor.
 *
...
class TagProcessor
{
    ...
    /**
     * Registers a callback function that handles enquire enquire markup.
     ...
     * the function should return a markup for the enquire enquire preview form or for the
     * front-end.
